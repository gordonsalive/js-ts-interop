...
const e = document.getElementById('howdy');
if (e) {
    e.innerHTML = `objects: ${JSON.stringify(window.Obj1)} , ${JSON.stringify(window.Obj2)}`;
} else {
    const e2 = document.getElementById('app');
    if (e2) {
        e2.innerHTML = `objects: ${JSON.stringify(window.Obj1)} , ${JSON.stringify(window.Obj2)}`;
    }
}
